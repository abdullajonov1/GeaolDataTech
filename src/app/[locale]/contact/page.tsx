 ...
 return <>
  ...
  <section className="contact-page">
   <div className="contact-info">
    ...
    <h2>{locale==='uz'?'Erkin MFY, 63-uy':locale==='ru'?'Эркин МФЙ, дом 63':'Erkin MFY, house 63'}<br/>{locale==='uz'?'Zangiota tumani, Toshkent viloyati':locale==='ru'?'р-н Зангиота, Ташкентская обл.':'Zangiota District, Tashkent Region'}</h2>
