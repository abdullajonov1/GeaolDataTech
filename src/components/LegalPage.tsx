...
const legal={
 privacy:{
  uz:{title:'Maxfiylik siyosati',updated:'HUQUQIY / YANGILANGAN 29.07.2026',sections:[
   ['1. Qamrov','Ushbu hujjat GEOLDATA TECH veb-saytidan foydalanish va formalar orqali yuborilgan ma’lumotlarga oid tamoyillarni tushuntiradi.'],
   ...
   ['4. Sizning huquqlaringiz','Yuborilgan ma’lumotlarga kirish, tuzatish yoki o‘chirishni hello@geoldatatech.uz orqali so‘rashingiz mumkin.'],
   ['5. Aloqa','Ushbu siyosat bo‘yicha savollarni hello@geoldatatech.uz manziliga yuboring.']
  ]},
  ru:{title:'Политика конфиденциальности',updated:'ПРАВОВОЕ / ОБНОВЛЕНО 29.07.2026',sections:[
   ['1. Область действия','Этот документ объясняет принципы использования сайта GEOLDATA TECH и обработки информации, отправленной через формы.'],
   ...
   ['4. Ваши права','Вы можете запросить доступ, исправление или удаление отправленных данных по адресу hello@geoldatatech.uz.'],
   ['5. Контакты','Вопросы по этой политике можно направлять на hello@geoldatatech.uz.']
  ]},
  en:{title:'Privacy Policy',updated:'LEGAL / UPDATED 29.07.2026',sections:[
   ['1. Scope','This document explains the principles governing use of the GEOLDATA TECH website and handling of information submitted through its forms.'],
   ...
   ['4. Your rights','You may request access, correction, or deletion of submitted information by contacting hello@geoldatatech.uz.'],
   ['5. Contact','Questions about this policy can be sent to hello@geoldatatech.uz.']
  ]}
 },
 terms:{
